...
- **Version:** 0.11.7 (approval candidate — awaiting Dr. Yasser's sign-off for v1.0)
...
│   │   ├── version.ts           # APP_VERSION = "0.11.7" (single source of truth)
...
| v0.11.5 | 2026-04-09 | Instruction PDF uses flowing footer (content on page 1, not pushed to page 2). Dialog max-height with scrollable content |
| v0.11.6 | 2026-04-09 | Reduced dialog max-height to 80vh |
| v0.11.7 | 2026-04-09 | Icon-only action buttons in instruction preview (WhatsApp, Email, Download, Print) — cleaner, fits all screens |
...
### Awaiting
- **Dr. Yasser's v1.0 approval** — v0.11.7 is the approval candidate
